...
describe('ImmutablePropTypes', function () {
  ...
  describe('OrderedMapContains Types', function () {
    ...
    it('should not warn for valid types', function () {
      typeCheckPass(PropTypes.orderedMapContains({key: ReactPropTypes.number}), Immutable.OrderedMap({key: 1}));
    });
    ...
    it('should warn for required valid types', function () {
      typeCheckFail(
        PropTypes.orderedMapContains({key: ReactPropTypes.number.isRequired}),
        Immutable.OrderedMap({}),
        'Required prop `testProp.key` was not specified in `testComponent`.'
      );
    });
    ...
    it('should warn for invalid key types', function () {
      typeCheckFail(PropTypes.orderedMapContains({key: ReactPropTypes.number}),
    ...
    it('should be implicitly optional and not warn without values', function () {
      typeCheckPass(
        PropTypes.orderedMapContains(PropTypes.orderedMapContains({key: ReactPropTypes.number})), null
      );
      typeCheckPass(
        PropTypes.orderedMapContains(PropTypes.orderedMapContains({key: ReactPropTypes.number})), undefined
      );
    });
